        ...
        <div :class="[...bgColorClasses, 'rounded-md p-4']">
            <div class="flex">
                <div class="flex-shrink-0">
                    <CheckCircleIcon :class="[iconColorClass, 'h-5 w-5']" aria-hidden="true" v-show="level === 'success'" />
                    <XCircleIcon :class="[iconColorClass, 'h-5 w-5']" aria-hidden="true" v-show="level === 'fail'" />
                    <InformationCircleIcon :class="[iconColorClass, 'h-5 w-5']" aria-hidden="true"
                        v-show="level === 'info'" />
                </div>
                <div class="ml-3">
                ...
                <div class="ml-auto pl-3">
                    <div class="-mx-1.5 -my-1.5">
                        <button @click="onDismiss" type="button" :class="[
