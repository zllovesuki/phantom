                    ...
                    <div class="md:col-span-1">
                        <div class="px-4 sm:px-0">
                            ...
                            <p class="mt-2 text-xs text-gray-600 dark:text-gray-500">
                                <StatusBadge :text="[ConnectedNodes.length > 0 ? 'Has' : 'No', 'Alive Nodes'].join(' ')"
                                    class="mb-2" :enabled="ConnectedNodes.length > 0">
                                    <template #enabled>
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        <dl class="sm:divide-y sm:divide-gray-200 dark:sm:divide-gray-600">
                                            ...
                                            <div class="py-4 sm:grid sm:grid-cols-4 sm:gap-4 sm:py-5">
                                                ...
                                                <dd class="mt-1 text-sm text-gray-900 dark:text-gray-300 sm:col-span-3 sm:mt-0 cursor-pointer"
                                                    @click="ShowToken = !ShowToken">
                                                    {{ ShowToken ? SpecterConfig.token : Array((SpecterConfig.token ??
                                                        '').length).fill('*').join('') }}
                                                </dd>
                                            </div>
