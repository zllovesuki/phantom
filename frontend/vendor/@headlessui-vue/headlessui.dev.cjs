...
function render(_a) {
  ...
  if (features & 1 /* RenderStrategy */) {
    ...
    return match(strategy, {
      ...
      [1 /* Hidden */]() {
        return _render(__spreadProps(__spreadValues({}, main), {
          props: __spreadProps(__spreadValues({}, props), { hidden: true, style: { display: "none" } })
        }));
      }
    });
  }
...
function _render({
  ...
  var _b, _c;
  let _a = omit(props, ["unmount", "static"]), { as } = _a, incomingProps = __objRest(_a, ["as"]);
  let children = (_b = slots.default) == null ? void 0 : _b.call(slots, slot);
  let dataAttributes = {};
  if (slot) {
  ...
  if (as === "template") {
    ...
    if (Object.keys(incomingProps).length > 0 || Object.keys(attrs).length > 0) {
      ...
      let mergedProps = mergeProps((_c = firstChild.props) != null ? _c : {}, incomingProps);
...
var Hidden = (0, import_vue8.defineComponent)({
  ...
  setup(props, { slots, attrs }) {
    return () => {
      let _a = props, { features } = _a, theirProps = __objRest(_a, ["features"]);
      let ourProps = {
...
var Combobox = (0, import_vue11.defineComponent)({
  ...
  setup(props, { slots, attrs, emit }) {
    ...
    return () => {
      let _a = props, { name, disabled } = _a, theirProps = __objRest(_a, ["name", "disabled"]);
      let slot = {
      ...
      return (0, import_vue11.h)(import_vue11.Fragment, [
        ...
        render({
          theirProps: __spreadValues(__spreadValues({}, attrs), omit(theirProps, [
            "modelValue",
            "defaultValue",
            "nullable",
            "multiple",
...
var ComboboxLabel = (0, import_vue11.defineComponent)({
  ...
  setup(props, { attrs, slots }) {
    ...
    return () => {
      ...
      let _a = props, { id: id2 } = _a, theirProps = __objRest(_a, ["id"]);
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    return () => {
      ...
      let ourProps = {
        ...
        "aria-controls": (_b = dom(api.optionsRef)) == null ? void 0 : _b.id,
        "aria-expanded": api.disabled.value ? void 0 : api.comboboxState.value === 0 /* Open */,
        "aria-labelledby": api.labelRef.value ? [(_c = dom(api.labelRef)) == null ? void 0 : _c.id, id2].join(" ") : void 0,
...
var ComboboxInput = (0, import_vue11.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    return () => {
      ...
      let _a = props, { id: id2, displayValue, onChange: _onChange } = _a, theirProps = __objRest(_a, ["id", "displayValue", "onChange"]);
      let ourProps = {
        "aria-controls": (_b = api.optionsRef.value) == null ? void 0 : _b.id,
        "aria-expanded": api.disabled.value ? void 0 : api.comboboxState.value === 0 /* Open */,
        "aria-activedescendant": api.activeOptionIndex.value === null ? void 0 : (_c = api.options.value[api.activeOptionIndex.value]) == null ? void 0 : _c.id,
...
var FocusTrap = Object.assign(
  (0, import_vue15.defineComponent)({
    ...
    setup(props, { attrs, slots, expose }) {
      ...
      useRestoreFocus(
        { ownerDocument },
        (0, import_vue15.computed)(() => Boolean(props.features & 16 /* RestoreFocus */))
      );
      let previousActiveElement = useInitialFocus(
        { ownerDocument, container, initialFocus: (0, import_vue15.computed)(() => props.initialFocus) },
        (0, import_vue15.computed)(() => Boolean(props.features & 2 /* InitialFocus */))
      );
      useFocusLock(
        {
          ownerDocument,
      ...
      return () => {
        ...
        let _a = props, { features, initialFocus, containers: _containers } = _a, theirProps = __objRest(_a, ["features", "initialFocus", "containers"]);
        return (0, import_vue15.h)(import_vue15.Fragment, [
          ...
          render({
            ourProps,
            theirProps: __spreadValues(__spreadValues({}, attrs), theirProps),
            slot,
            attrs,
            slots,
            name: "FocusTrap"
...
var ForcePortalRoot = (0, import_vue17.defineComponent)({
  ...
  setup(props, { slots, attrs }) {
    ...
    return () => {
      let _a = props, { force } = _a, theirProps = __objRest(_a, ["force"]);
      return render({
        theirProps,
        ourProps: {},
        slot: {},
...
var PortalGroup = (0, import_vue18.defineComponent)({
  ...
  setup(props, { attrs, slots }) {
    ...
    return () => {
      let _a = props, { target: _ } = _a, theirProps = __objRest(_a, ["target"]);
      return render({
        theirProps,
        ourProps: {},
        slot: {},
...
var Description = (0, import_vue20.defineComponent)({
  ...
  setup(myProps, { attrs, slots }) {
    ...
    return () => {
      ...
      let _a = myProps, { id: id2 } = _a, theirProps = __objRest(_a, ["id"]);
      let ourProps = __spreadProps(__spreadValues({}, Object.entries(props).reduce(
...
var Dialog = (0, import_vue23.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    return () => {
      let _a2 = props, { id: id2, open: _, initialFocus } = _a2, theirProps = __objRest(_a2, ["id", "open", "initialFocus"]);
      let ourProps = __spreadProps(__spreadValues({}, attrs), {
...
var Disclosure = (0, import_vue24.defineComponent)({
  ...
  setup(props, { slots, attrs }) {
    ...
    return () => {
      let _a = props, { defaultOpen: _ } = _a, theirProps = __objRest(_a, ["defaultOpen"]);
...
var Listbox = (0, import_vue25.defineComponent)({
  ...
  setup(props, { slots, attrs, emit }) {
    ...
    return () => {
      let _a = props, { name, modelValue, disabled } = _a, theirProps = __objRest(_a, ["name", "modelValue", "disabled"]);
...
var ListboxOption = (0, import_vue25.defineComponent)({
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    return () => {
      let { disabled } = props;
      let slot = { active: active.value, selected: selected.value, disabled };
      let _a = props, { id: id2, value: _value, disabled: _disabled } = _a, theirProps = __objRest(_a, ["id", "value", "disabled"]);
      let ourProps = {
        id: id2,
        ref: internalOptionRef,
        role: "option",
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    return () => {
      ...
      let ourProps = {
        ...
        type: type.value,
        "aria-haspopup": "menu",
        "aria-controls": (_b = dom(api.itemsRef)) == null ? void 0 : _b.id,
...
var MenuItems = (0, import_vue26.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    return () => {
      ...
      let _a = props, { id: id2 } = _a, theirProps = __objRest(_a, ["id"]);
      let ourProps = {
        "aria-activedescendant": api.activeItemIndex.value === null ? void 0 : (_b = api.items.value[api.activeItemIndex.value]) == null ? void 0 : _b.id,
        "aria-labelledby": (_c = dom(api.buttonRef)) == null ? void 0 : _c.id,
        id: id2,
        onKeydown: handleKeyDown,
        onKeyup: handleKeyUp,
        role: "menu",
...
var PopoverPanel = (0, import_vue27.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    return () => {
      ...
      let _a = props, { id: id2, focus: _focus } = _a, theirProps = __objRest(_a, ["id", "focus"]);
      let ourProps = {
        ref: api.panel,
        id: id2,
        onKeydown: handleKeyDown,
...
var Label = (0, import_vue28.defineComponent)({
  ...
  setup(myProps, { slots, attrs }) {
    ...
    return () => {
      ...
      let _a = myProps, { id: id2, passive } = _a, theirProps = __objRest(_a, ["id", "passive"]);
      let ourProps = __spreadProps(__spreadValues({}, Object.entries(props).reduce(
...
var RadioGroup = (0, import_vue29.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    return () => {
      let _a = props, { disabled, name, id: id2 } = _a, theirProps = __objRest(_a, ["disabled", "name", "id"]);
      let ourProps = {
        ref: radioGroupRef,
        id: id2,
        role: "radiogroup",
      ...
      return (0, import_vue29.h)(import_vue29.Fragment, [
        ...
        render({
          ourProps,
          theirProps: __spreadValues(__spreadValues({}, attrs), omit(theirProps, ["modelValue", "defaultValue"])),
          slot: {},
          attrs,
          slots,
          name: "RadioGroup"
...
var Switch = (0, import_vue30.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    return () => {
      let _a = props, { id: id2, name, value } = _a, theirProps = __objRest(_a, ["id", "name", "value"]);
      ...
      return (0, import_vue30.h)(import_vue30.Fragment, [
        ...
        render({
          ourProps,
          theirProps: __spreadValues(__spreadValues({}, attrs), omit(theirProps, ["modelValue", "defaultChecked"])),
          slot,
          attrs,
          slots,
          name: "Switch"
  ...
  setup(props, { slots, attrs, emit }) {
    ...
    return () => {
      ...
      return (0, import_vue32.h)(import_vue32.Fragment, [
        ...
        render({
          theirProps: __spreadValues(__spreadValues({}, attrs), omit(props, ["selectedIndex", "defaultIndex", "manual", "vertical", "onChange"])),
          ourProps: {},
          slot,
          slots,
          attrs,
...
var TabPanel = (0, import_vue32.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    return () => {
      var _b;
      let slot = { selected: selected.value };
      let _a = props, { id: id2, tabIndex } = _a, theirProps = __objRest(_a, ["id", "tabIndex"]);
      let ourProps = {
        ref: internalPanelRef,
        id: id2,
        role: "tabpanel",
        "aria-labelledby": (_b = dom(api.tabs.value[myIndex.value])) == null ? void 0 : _b.id,
        tabIndex: selected.value ? tabIndex : -1
      };
      if (!selected.value && props.unmount && !props.static) {
        return (0, import_vue32.h)(Hidden, __spreadValues({ as: "span" }, ourProps));
      }
      return render({
        ourProps,
        theirProps,
...
var TransitionChild = (0, import_vue33.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    return () => {
      ...
      let theirProps = __spreadValues(__spreadValues({}, rest), appear && show && env.isServer ? {
...
var TransitionRoot = (0, import_vue33.defineComponent)({
  ...
  setup(props, { emit, attrs, slots }) {
    ...
    return () => {
      ...
      return render({
        ourProps: __spreadProps(__spreadValues({}, sharedProps), {
          as: "template"
        }),
        theirProps: {},
        slot: {},
